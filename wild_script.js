...
const additionalOut = ["Ref Mileage", "Ref Fee", "Announcer", "Security", "50/50 Winner", "Photographer", "Other (Out)"];
...
{
	var totalFloat = 0,cashHandedIn = 0,emt = 0,overallRevenue = 0;
	...
	overallRevenue = cashHandedIn + emt - totalFloat;	
		
	$(".overall-total-cash-amount").text(cashHandedIn.toFixed(2));
